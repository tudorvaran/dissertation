...
\begin{itemize}
\item{Agglomerative hierarchical clustering: clusters a creating by merging;}
\item{Divisive hierarchical clustering: clusters are creating by dividing.}
\end{itemize} 
...
Suppose $d=2$, which means inserting a new item requires searching in a square of size $(3\delta)^2$ with 9 paritions for elements which are in a circle of radius $\delta$. The change of finding the required elements on average is 
